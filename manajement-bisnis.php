...
<head>
  ...
  <title>Teknik Manajement Bisnis - Portofolio PBL</title>
...
<body>
  ...
  <section class="hero position-relative">
    <div class="container text-center">
      <h1>Manajement Bisnis</h1>
      <p>Menampilkan inovasi, kreativitas, dan solusi digital mahasiswa dalam bidang teknologi informasi.</p>
    </div>
    <div class="hero-divider"></div>
  </section>

 <!-- Proyek Mahasiswa Manajemen Bisnis -->
<section class="py-5">
  <div class="container">
    <h3 class="fw-bold mb-4 text-center">Proyek Mahasiswa Manajemen Bisnis</h3>

    <div class="row justify-content-center g-4">
      <!-- Analisis Pasar & Strategi -->
      <div class="col-md-4 d-flex">
        <div class="card p-3 text-center flex-fill">
          <img src="https://cdn-icons-png.flaticon.com/512/3062/3062634.png" width="80" class="mx-auto mb-3" alt="Analisis Pasar">
          <h5 class="text-center"><a href="analisis-pasar.php">Analisis Pasar & Strategi</a></h5>
          <p class="small text-center">Proyek menganalisis tren pasar, perilaku konsumen, dan strategi pemasaran untuk bisnis nyata.</p>
        </div>
      </div>
      ...
      <div class="col-md-4 d-flex">
        <div class="card p-3 text-center flex-fill">
          <img src="https://cdn-icons-png.flaticon.com/512/2910/2910747.png" width="80" class="mx-auto mb-3" alt="Startup Bisnis">
          <h5 class="text-center"><a href="startup-inovasi.php">Startup & Inovasi Bisnis</a></h5>
          <p class="small text-center">Proyek inovasi bisnis, pengembangan ide startup, dan strategi pengelolaan usaha modern.</p>
        </div>
      </div>
  </section>
