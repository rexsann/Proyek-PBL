...
<head>
  ...
  <title>Portofolio PBL - Tentang</title>
...
<section class="py-5 text-center">
  <div class="container">
    <h2 class="fw-bold">Tentang Portofolio PBL</h2>
    <p class="text-light">Platform digital karya mahasiswa Polibatam berbasis Project Based Learning.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        ...
        <p>
          <strong>Portofolio PBL</strong> adalah platform untuk menampilkan karya mahasiswa
          Politeknik Negeri Batam dalam sistem Project Based Learning.
        </p>
        <p>
          Website ini digunakan mahasiswa, dosen, serta publik untuk melihat hasil proyek
        ...
        <div class="mt-4 d-flex flex-column gap-3">
          <div class="d-flex gap-3">
            ...
            <div>
              ...
              <p class="small mb-0">Mendorong kreativitas dalam berbagai proyek.</p>
            </div>
          </div>
          ...
          <div class="d-flex gap-3">
            ...
            <div>
              ...
              <p class="small mb-0">Memperkuat kerja sama lintas jurusan.</p>
            </div>
          </div>
          ...
          <div class="d-flex gap-3">
            ...
            <div>
              ...
              <p class="small mb-0">Fokus menghasilkan karya yang benar-benar aplikatif.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5 text-center">
        <img src="whatsapp_image.jpeg" alt="About Image"
          class="img-fluid rounded-4 shadow-lg" style="max-width: 350px;">
      </div>
    </div>
  </div>
</section>
