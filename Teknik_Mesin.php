...
<head>
  ...
  <title>Teknik Mesin - Portofolio PBL</title>
...
<body>
        ...
        <ul class="navbar-nav me-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="#">Teknik Mesin</a></li>
 ...
 <!-- Proyek Mahasiswa Teknik Mesin D4 -->
<section class="py-5">
  <div class="container">
    <h3 class="fw-bold mb-4 text-center">Proyek Mahasiswa Teknik Mesin D4</h3>

    <div class="row justify-content-center g-4">
      <!-- Desain Mesin -->
      <div class="col-md-4 d-flex">
        <div class="card p-3 text-center flex-fill">
          <img src="https://cdn-icons-png.flaticon.com/512/2905/2905028.png" width="80" class="mx-auto mb-3" alt="Desain Mesin">
          <h5 class="text-center"><a href="desain-mesin.php">Desain Mesin</a></h5>
          <p class="small text-center">Proyek perancangan mekanik, termasuk CAD dan simulasi struktural komponen mesin.</p>
        </div>
      </div>
      ...
      <div class="col-md-4 d-flex">
        <div class="card p-3 text-center flex-fill">
          <img src="https://cdn-icons-png.flaticon.com/512/2910/2910752.png" width="80" class="mx-auto mb-3" alt="Simulasi Mekanik">
          <h5 class="text-center"><a href="simulasi-mekanik.php">Simulasi Mekanik</a></h5>
          <p class="small text-center">Proyek simulasi mekanik, analisis gerak, dan optimasi sistem mekanis menggunakan software CAD/CAE.</p>
        </div>
      </div>
