...
<body>
    <div class="detail-card">
            ...
            <?php if ($komentarResult->num_rows > 0): ?>
                <?php while ($k = $komentarResult->fetch_assoc()): ?>
                    ...
                    <div class="comment-box d-flex gap-3">
                        ...
                        <!-- Tombol Hapus -->
                        <?php if ($role === 'mahasiswa' && isset($k['nim']) && $k['nim'] == $_SESSION['nim']): ?>
        ...
        <div class="mt-4 d-flex justify-content-between">
            <?php if ($isOwner): ?>
                <a href="edit.php?id=<?= $data['id'] ?>" class="btn btn-edit px-4">✏️ Edit</a>
